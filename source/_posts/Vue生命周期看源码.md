...
通过Vue源码core->instance->lifecycle.js 定义了8个生命周期的方法
...
# 7.deactivated
```js
/*使子组件状态都改编成deactivate同时调用deactivated钩子*/
function deactivateChildComponent (vm: Component, direct?: boolean) {
  if (direct) {
